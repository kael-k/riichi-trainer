...
**Plans**: 5/7 plans executed, in 6 execution waves — see
...
- [x] 01-05-PLAN.md — split the efficiency trainer into solitaire and table routes; `opponents`
...
|-------|-----------------|--------|-----------|
| 1. Table architecture centralization | 5/7 | In Progress|  |
