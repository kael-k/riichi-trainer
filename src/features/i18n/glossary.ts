...
export const GLOSSARY = {
  ...
  tedashi: { labelKey: 'glossary.tedashi.term', descKey: 'glossary.tedashi.desc', wikiUrl: 'https://riichi.wiki/Tedashi_and_tsumogiri' },
  tsumogiri: { labelKey: 'glossary.tsumogiri.term', descKey: 'glossary.tsumogiri.desc', wikiUrl: 'https://riichi.wiki/Tedashi_and_tsumogiri' },
